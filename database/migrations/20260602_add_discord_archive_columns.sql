...
COMMENT ON COLUMN public.gif_commands.asset_path IS 'Discord attachment URL for the archived media reference.';
COMMENT ON COLUMN public.gif_commands.image_path IS 'Legacy alias for the archived Discord attachment URL.';
COMMENT ON COLUMN public.gif_commands.attachment_url IS 'Canonical Discord attachment URL for the archived media reference.';
