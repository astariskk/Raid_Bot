...
export const NO_TASK_HELPED_VALUE = '__none__';
...
export function buildAttachPartialTasksModal(partialHelpers, taskKeys) {
  ...
  const taskSelect = new StringSelectMenuBuilder()
    ...
    .setMinValues(1)
    .setMaxValues(Math.max(1, Math.min(25, keys.length + 1)))
    .addOptions(
      [
        new StringSelectMenuOptionBuilder()
          .setLabel('No task helped')
          .setValue(NO_TASK_HELPED_VALUE)
          .setDescription('This helper did not help with any tasks'.slice(0, 100)),
